      ...
      <div className="max-w-7xl mx-auto space-y-6">
        ...
        <div className="flex flex-wrap items-center gap-2 border-b border-slate-200 pb-2">
          <button
            ...
            className={`flex items-center gap-2 px-4 py-2 rounded-lg text-xs font-bold transition-colors focus-visible:ring-2 focus-visible:ring-slate-900 focus-visible:outline-hidden ${
